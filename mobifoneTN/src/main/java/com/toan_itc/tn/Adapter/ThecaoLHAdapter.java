 ...
 */
public class ThecaoLHAdapter extends RecyclerView.Adapter<ThecaoLHAdapter.ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClickTheCaoLH(String link);
    }

    public static final String LOG_TAG = ThecaoLHAdapter.class.getSimpleName();

    protected OnItemClickListener onItemClickListener;

    private List<DSlienhenapthecao> articles;

    public ThecaoLHAdapter(@NonNull Context context, List<DSlienhenapthecao> articles, OnItemClickListener onItemClickListener) {
        if (articles == null) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        final DSlienhenapthecao data = this.articles.get(position);
        ...
        viewHolder.setOnClickListener(view -> {
            ...
            onItemClickListener.onItemClickTheCaoLH(phone);
        });
    }
    ...
    public DSlienhenapthecao getLastArticle() {
        if (articles.size() > 0) {
