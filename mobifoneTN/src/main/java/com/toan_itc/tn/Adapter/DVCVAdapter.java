 ...
 */
public class DVCVAdapter extends RecyclerView.Adapter<DVCVAdapter.ViewHolder>  {
    ...
    public static final String LOG_TAG = DVCVAdapter.class.getSimpleName();

    protected OnItemClickListener onItemClickListener;

    private List<DStinCVQT> articles;

    public DVCVAdapter(@NonNull Context context, List<DStinCVQT> articles, OnItemClickListener onItemClickListener) {
        if (articles == null) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        final DStinCVQT data = this.articles.get(position);
    ...
    public DStinCVQT getLastArticle() {
        if (articles.size() > 0) {
