...
public final class CustomTabsSession {
     ...
     *                           {@link Uri} using {@link android.support.customtabs.CustomTabsService#KEY_URL} with
     ...
     * {@link android.support.customtabs.CustomTabsIntent#TOOLBAR_ACTION_BUTTON_ID}.
     *
     ...
     * {@link android.support.customtabs.CustomTabsService#requestPostMessageChannel(
     ...
     * @return An integer constant about the postMessage request result. Will return
      *        {@link android.support.customtabs.CustomTabsService#RESULT_SUCCESS} if successful.
     */
    @Result
